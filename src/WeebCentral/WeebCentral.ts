...
const SOURCE_DOMAIN = "https://weebcentral.com"
...
export class WeebCentral extends Source {
    ...
    get name(): string { return 'WeebCentral' }
    get description(): string { return 'A source containing manga from WeebCentral, the descendant of Manga4Life and MangaSee' }
    get author(): string { return 'Plancktron' }
